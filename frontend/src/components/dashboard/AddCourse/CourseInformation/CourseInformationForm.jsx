  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col space-y-2">
        <label className="text-sm text-gray-400" htmlFor="courseTitle">
      ...
      <div className="flex flex-col space-y-2">
        <label className="text-sm text-gray-400" htmlFor="courseShortDesc">
      ...
      {/* Course Price */}
      <div className="flex flex-col space-y-2">
        <label className="text-sm text-gray-400" htmlFor="coursePrice">
      ...
      {/* Course Category */}
      <div className="flex flex-col space-y-2">
        <label className="text-sm text-gray-400" htmlFor="courseCategory">
      ...
      <div className="flex flex-col space-y-2">
        <label className="text-sm text-gray-400" htmlFor="courseBenefits">
