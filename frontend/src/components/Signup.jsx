    ...
    <div className="relative h-screen font-sans">
      ...
      <div className="relative z-10 flex justify-center items-center h-full">
        <div className="bg-white bg-opacity-90 backdrop-blur-md p-10 rounded-xl shadow-2xl gap-y-5 w-full max-w-lg">
          ...
          {/* Input fields */}
          <div className="mb-6">
            <input type="text" placeholder="First Name" className="w-full mb-4 p-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:outline-none transition duration-300" />
            <input type="text" placeholder="Last Name" className="w-full mb-4 p-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:outline-none transition duration-300" />
            ...
            <input type="password" placeholder="Confirm Password" className="w-full mb-4 p-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:outline-none transition duration-300" />
            <input type="tel" placeholder="Mobile No" className="w-full mb-6 p-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:outline-none transition duration-300" />
          </div>
